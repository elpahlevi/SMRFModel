...
#this script contains preprocessing satellite image from radiometric correction to calculate surface temperature
class gis():
    workDIR = r"D:/arcpy"
    ...
    shapeFile = "/shapeFile"
    ndvi_image = "/trainingData/ndvi"
    brightness_temp = "/tb"
    emissivity_image = "/ems"
    count = 0
    ...
    def ndvi(self):
        ...
        ndvi_output = "D:/arcpy/results/trainingData/ndvi/NDVI_kulonprogo.TIF"
    ...
    def t_brightness(self):
        ...
        rad_mult = 0.0003342
        rad_add = 0.1
        b10_clip = "D:/arcpy/results/tb/b10_kulonprogo.TIF"
        b11_clip = "D:/arcpy/results/tb/b11_kulonprogo.TIF"
        tb_output = "D:/arcpy/results/tb/tb_kulonprogo.TIF"
    ...
    def surfaceTemp(self):
        ENV.workspace = self.outDIR+self.brightness_temp
        ems_image = arcpy.sa.Raster(self.outDIR+self.emissivity_image+"/ems_kulonprogo.TIF")
        tb_image = arcpy.sa.Raster("tb_kulonprogo.TIF")
        ts_output = "D:/arcpy/results/ts/ts_kulonprogo.TIF"
        w = 11.5
        p = 14380
        tb = tb_image / (1 + (w*(tb_image/p)*Ln(ems_image)))
        tb.save(ts_output)
...
#tb_run = gis().t_brightness()
#ts_run = gis().surfaceTemp()